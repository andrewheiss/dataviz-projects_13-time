...
format:
  ...
  typst:
    toc: true
    toc-title: Contents
    output-file: PREFIX_13-exercise.pdf
    pdf-standard: ua-1
...
#| out-width: "80%"
#| fig-alt: |
#|   Line chart of monthly average atmospheric CO₂ at Mauna Loa Observatory,
#|   1958–2025. Date on the x-axis, CO₂ in parts per million on the y-axis.
#|   A gray line shows raw monthly averages with visible seasonal oscillation;
#|   a red line shows the deseasonalized trend. CO₂ has risen steadily from
#|   approximately 315 ppm in 1958 to 425 ppm in 2025.
...
#| out-width: "80%"
#| fig-alt: |
#|   Scatter and line chart of atmospheric CO₂ at Mauna Loa Observatory from
#|   2020 to 2025. Date on the x-axis, CO₂ in parts per million on the
#|   y-axis. Tiny gray dots show individual daily readings with seasonal
#|   oscillation; a red line shows the smoothed monthly deseasonalized trend.
#|   The upward trajectory continues at roughly 2–3 ppm per year.
...
#| out-width: "60%"
#| fig-alt: |
#|   Scatter and smooth line chart of CO₂ seasonal variation at Mauna Loa
#|   during 2024. Months on the x-axis, difference from the annual mean CO₂
#|   (ppm) on the y-axis. A horizontal line marks zero (the annual mean).
#|   The smooth blue curve peaks above the mean in spring and dips below it
#|   in early fall, reflecting Northern Hemisphere plant growth and decay
#|   cycles.
...
#| out-width: "80%"
#| fig-alt: |
#|   Combined chart showing the full 1958–2025 Mauna Loa CO₂ record with a
#|   seasonal variation inset. The main plot shows monthly CO₂ averages
#|   (gray) and the deseasonalized trend (red) rising from 315 to 425 ppm.
#|   A smaller inset in the upper-left shows the 2024 seasonal cycle,
#|   illustrating how the annual sawtooth oscillation relates to the
...
#| fig-height: 3
#| fig-alt: |
#|   Line chart of annual CO₂ emissions per capita for nine countries and
#|   regions, roughly 1750–2023. Year on the x-axis, tonnes of CO₂ per
#|   person on the y-axis, with one colored line per entity directly labeled
#|   at the right edge. The United States and Canada are historically the
#|   highest emitters; India and Kenya remain among the lowest.
...
#| fig-height: 2
#| fig-alt: |
#|   Warming stripes visualization covering roughly 1850–2023. A single row
#|   of vertical color tiles, one per year, colored from deep blue (cooler
#|   years) to deep red (warmer years) relative to the 1961–1990 baseline.
#|   The progression from predominantly blue tiles on the left to
#|   overwhelmingly red tiles on the right illustrates accelerating global
#|   warming through the 20th and into the 21st century.
...
#| fig-height: 2
#| fig-alt: |
#|   Bar chart version of warming stripes on a dark background, spanning
#|   roughly 1850–2023. Year on the x-axis, temperature anomaly in Celsius
#|   on the y-axis, bars colored from blue (negative/cool anomalies) to red
#|   (positive/warm anomalies). Mostly blue bars in the early record give way
#|   to predominantly tall red bars in recent decades, emphasizing the
